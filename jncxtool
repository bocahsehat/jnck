#-[Metadata]----------------------------------------------------#
#  Filename: Jncx    [Update: 26-11-2021] #
#                                                               #
#-[Info]--------------------------------------------------------#
...
def startbar():
    with Bar(bC+"["+r+rC2+"-"+r+bC+"]"+r+bC+"──["+r+gC+"Starting the JncxToolkit..."+bC+"]"+r) as bar:
        for i in range(100):
            time.sleep(0.02)
            bar.next()
...
def informationgathering_mainpage():
    ...
    print(bC+"             ║"+r)
    print(bC+"             ╟──── ["+r+gC+"  Made by   "+r+bC+"] ───"+r+gC+"► "+r+rC+"XxX"+r+bC2+" (© Jncx_Society™)"+r)
    ...
    while True:
        try:
            print(bC+"┌─("+r+rC+"JncxToolkit"+r+bC+")─["+r+yC+"~"+r+bC+"]─["+r+gC+"Information Gathering"+r+bC+"]")
...
def scan_mainpage():
    ...
    print(bC+"     ╙────╖")
    print(bC+"          ╟──────"+r+gC+"►"+r+bC2+" Created by :"+r+rC+"  XxX"+r+bC2+" (© Jncx_Society™)"+r)
    ...
    while True:
        try:
            print(bC+"┌─("+r+rC+"JncxToolkit"+r+bC+")─["+r+yC+"~"+r+bC+"]─["+r+gC+"Information Gathering | ScanTools"+r+bC+"]")
...
def windowstools_mainpage():
    ...
    while True:
        try:
            print(bC+"┌─("+r+rC+"JncxToolkit"+r+bC+")─["+r+yC+"~"+r+bC+"]─["+r+gC+"UWTools"+r+bC+"]")
